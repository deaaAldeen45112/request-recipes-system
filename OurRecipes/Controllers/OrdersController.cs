...
namespace OurRecipes.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(AppDbContext context, IToastNotification notyf, IHubContext<OrderHub> hubContext)
        {
            _context = context;
                ...
                if (recipe is not null && userId is not null) {
                    ...
                    if (card is not null)
                    {
                       ...
                       await InvoicePdfTemplate((int)order.OrderId);
                        ...
                        await _hubContext.Clients.User(userId.ToString()).SendAsync("ReceiveNotification", "A new order has been placed.");
